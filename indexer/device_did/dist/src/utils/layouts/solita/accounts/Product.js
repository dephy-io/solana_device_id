...
export class Product {
    constructor(name, devicesNums, bumpSeed) {
        this.name = name;
        this.devicesNums = devicesNums;
    ...
    static async getMinimumBalanceForRentExemption(args, connection, commitment) {
        return connection.getMinimumBalanceForRentExemption(Product.byteSize(args), commitment);
    }
    /**
