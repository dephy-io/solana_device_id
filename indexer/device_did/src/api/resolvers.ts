...
export class APIResolvers {
  ...
  async getAccounts(args: AccountsFilters): Promise<DeviceDidAccountInfo[]> {
  ...
  protected async filterAccounts({
    ...
    accounts,
    includeStats,
  }: AccountsFilters): Promise<DeviceDidAccountData[]> {
